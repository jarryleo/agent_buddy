...
class CalendarTool extends ToolBase {
  @override String get id => 'calendar';
  @override String get name => '日历';
  @override String get description => '管理手机日历(增删改查)。需要日历权限。仅 Android / iOS 可用。';
  ...
  @override Map<String, dynamic> buildSchema() {
    ...
    return {
      'type': 'function',
      'function': {
        'name': 'calendar', 'description': description,
        'parameters': {
          'type': 'object',
          'properties': {
            ...
            'start_ms': {'type': 'integer', 'description': 'create/update 开始时间(Unix 毫秒)'},
            'end_ms': {'type': 'integer', 'description': 'create/update 结束时间(Unix 毫秒,可选)'},
