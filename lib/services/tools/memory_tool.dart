        ...
        'parameters': {
          ...
          'properties': {
            'action': {
              ...
              'description':
                  '操作: list/search/get/create/update/delete/delete_batch',
            },
            ...
            'content': {
              'type': 'string',
              'description': 'create 必填,update 可选。写的时候多提炼关键词',
            },
            'ids': {
              'type': 'array',
              'items': {'type': 'string'},
    ...
    switch (action) {
      ...
      case actionCreate:
        ...
        final tags = tagsRaw is List
            ? tagsRaw.map((e) => e.toString()).toList()
            : const <String>[];
        final m = await mem.add(content: content, source: 'ai', tags: tags);
